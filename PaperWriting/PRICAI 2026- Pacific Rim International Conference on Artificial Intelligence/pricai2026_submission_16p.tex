...
\begin{table}[t]
    ...
    \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} p{2.1cm} p{4.45cm} c c}
        ...
        Reputation & \textbf{Dual-stream Trust Flow} & \textbf{0.05\% FPR} & \textbf{98.50\% TPR} \\
        \midrule
